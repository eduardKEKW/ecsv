                ...
                <div class="form-container">
                    ...
                    <accordian :title="'{{ __('admin::app.catalog.categories.general') }}'" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('front_visible') ? 'has-error' : '']">
                                <label for="front_visible" class="required">Visible In Front</label>
                                <select class="control" v-validate="'required'" id="front_visible" name="front_visible" data-vv-as="&quot;{{ __('admin::app.catalog.categories.visible-in-menu') }}&quot;">
                                    <option value="1" {{ $category->front_visible ? 'selected' : '' }}>
                                        {{ __('admin::app.catalog.categories.yes') }}
                                    </option>
                                    <option value="0" {{ $category->front_visible ? '' : 'selected' }}>
                                        {{ __('admin::app.catalog.categories.no') }}
                                    </option>
                                </select>
                                <span class="control-error" v-if="errors.has('front_visible')">@{{ errors.first('front_visible') }}</span>
                            </div>



                            {{-- <div for="front_visible" class="required">{{ __('admin::app.catalog.categories.front_visible') }}</label>
                                <select class="control-group" :class="[errors.has('front_visible') ? 'has-error' : '']">
                                <label class="control" v-validate="'required'" id="front_visible" name="front_visible" data-vv-as="&quot;{{ __('admin::app.catalog.categories.front_visible') }}&quot;">
                                    <option value="1" {{ $category->front_visible ? 'selected' : '' }}>
                                        {{ __('admin::app.catalog.categories.yes') }}
                                    </option>
                                    <option value="0" {{ $category->front_visible ? '' : 'selected' }}>
