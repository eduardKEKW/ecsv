...
class Product extends Model implements ProductContract
{
    ...
    {
        // throw new \Exception(json_encode($this->hasOne(ProductFlatProxy::modelClass(), 'product_id')->first()), 1);
        
        return $this->hasOne(ProductFlatProxy::modelClass(), 'product_id');
    }

    public function default_flat($data)
    {
        
        // throw new \Exception(json_encode($this->hasOne(ProductFlatProxy::modelClass(), 'product_id')->first()), 1);
        
        return $this->product_flat->where('locale', 'en')->first();
    }
    /**
